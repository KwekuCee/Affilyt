...
import { Linkedin, Twitter, Github, Mail, Shield, Zap, Globe, MessageSquare } from "lucide-react";
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <nav className="flex flex-col gap-3">
                            ...
                            <Link to="/dashboard/affiliate" className="text-sm text-muted-foreground hover:text-foreground transition-colors w-fit">Partner Dashboard</Link>
                            ...
                            <Link to="#" className="text-sm text-muted-foreground hover:text-foreground transition-colors w-fit">API Integration</Link>
                        </nav>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <nav className="flex flex-col gap-3">
                            <Link to="#" className="text-sm text-muted-foreground hover:text-foreground transition-colors w-fit">Institutional Terms</Link>
                            <Link to="#" className="text-sm text-muted-foreground hover:text-foreground transition-colors w-fit">Privacy Framework</Link>
                            <Link to="#" className="text-sm text-muted-foreground hover:text-foreground transition-colors w-fit">Network Rules</Link>
                            <Link to="#" className="text-sm text-muted-foreground hover:text-foreground transition-colors w-fit">Compliance Docs</Link>
                        </nav>
                    </div>
